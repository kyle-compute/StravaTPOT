...
Revision ID: 11676a3c0854
Revises: 16c3531b351e
Create Date: 2025-07-14 16:34:10.808366
...
def upgrade() -> None:
    ...
    sa.Column('backfill_status', sa.Enum('PENDING', 'QUEUED', 'IN_PROGRESS', 'COMPLETED', 'FAILED', name='backfillstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_activity_best_efforts_user_id'), 'activity_best_efforts', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_activity_best_efforts_user_id'), table_name='activity_best_efforts')
